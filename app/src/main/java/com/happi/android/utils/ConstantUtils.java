...
public class ConstantUtils {
    ...
    public static final int CHANNEL_LIST_ACTIVITY = 5;
    public static final int CHANNEL_HOME_ACTIVITY = 6;
    public static final int CATEGORYVIEW_ACTIVITY = 7;
    public static final int SHOWSVIDEO_ACTIVITY = 8;
    ...
    public static final String SHOWS_THUMBNAIL = "https://gizmeon.s.llnwi" +
            ".net/vod/thumbnails/show_logo/";
