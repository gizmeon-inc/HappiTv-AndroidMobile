...
public class ChannelHomeActivity extends BaseActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* timerVideoHandler = new Handler();
        ...
        liveScheduleAdapter = new LiveScheduleAdapter(ChannelHomeActivity.this, getApplicationContext(), this::onScheduleClicked);
        ...
        iv_schedule_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //   Toast.makeText(ChannelHomeActivity.this,"clicked",Toast.LENGTH_SHORT).show();
                Intent scheduleIntent = new Intent(ChannelHomeActivity.this, LiveScheduleActivity.class);
...
//                adsRenderingSettings.setUiElements(var);
                ...
                mAdsManager.addAdErrorListener(ChannelHomeActivity.this);
                mAdsManager.addAdEventListener(ChannelHomeActivity.this);
...
//"android-phone",
    ...
    private void populateHome(List<ASTVHome> data) {
       ...
       // tv_channel_title.setText(pHome.getChannelName());
        ...
        Glide.with(ChannelHomeActivity.this)
                .load(ConstantUtils.CHANNEL_NEW_THUMBNAIL + pHome.getLogo())
                .error(Glide.with(ChannelHomeActivity.this).load(ContextCompat.getDrawable(ChannelHomeActivity.this, R.drawable.ic_placeholder)))
...
*/
    ...
    private void checkPremium(List<ASTVHome> tHome) {
        ...
        if (premiumFlag == null) {
           ...
           // loadScheduleDetails();
            ...
            //premiumFlag is not null
            if (premiumFlag.equals("1")) {
                ApiClient.UsersService usersService = ApiClient.create();
    ...
    private void goToPremiumContent() {
        ...
        SharedPreferenceUtility.setChannelId(CHANNEL_ID);
        Intent intent = new Intent(ChannelHomeActivity.this, SubscriptionActivity.class);
    ...
    private void openFullscreen() {
        ...
        exo_fullscreen_icon.setImageDrawable(ContextCompat.getDrawable(ChannelHomeActivity.this, R.drawable.ic_fullscreen_skrink));
    ...
    private void closeFullscreen() {
        ...
        exo_fullscreen_icon.setImageDrawable(ContextCompat.getDrawable(ChannelHomeActivity.this, R.drawable.ic_fullscreen_white));
...
//        epoch = curr.getTime().getTime();
        NotificationTriggerActivity.sendNotifications(epoch, videoTitle, channelId, uniqueId,ChannelHomeActivity.this);
    ...
    public void notificationOff(ScheduleUpdatedModel scheduleUpdatedModel) {
        ...
        NotificationTriggerActivity.clearNotification(unique_id, ChannelHomeActivity.this);
        ArrayList<Integer> listOfIds = SharedPreferenceUtility.getNotificationIds();
